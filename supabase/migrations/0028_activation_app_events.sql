...
comment on constraint app_events_event_name_check on public.app_events is
  'Allowlist de eventos seguros do MVP, ativacao, beta fechado, lancamento pequeno e operacao pos-MVP. Nao salvar perguntas, respostas, contatos, tokens, pagamentos ou secrets.';
