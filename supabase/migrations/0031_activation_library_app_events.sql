...
comment on constraint app_events_event_name_check on public.app_events is
  'Allowlist de eventos seguros de ativacao e biblioteca. Nao salvar perguntas, respostas, suporte sensivel, contatos, tokens, pagamentos, payloads Stripe ou secrets.';
